...
function CopyableToken({ raw }) {
  ...
  return (
    <span
      onClick={onCopy}
      role="button"
      className={`cursor-pointer select-text font-semibold underline underline-offset-[3px] decoration-1 transition-colors ${copied ? 'text-[#1E9E4E] decoration-[#1E9E4E]/50' : 'text-[#E2319B] decoration-[#E2319B]/45 active:text-[#C01A7E]'}`}
    >
      {raw}
    </span>
  )
