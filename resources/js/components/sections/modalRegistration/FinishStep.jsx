  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-xl/[100%] font-semibold text-[#111]">{t('booking.finishTitle')}</h1>
        <p className="text-sm/[100%] text-[#7F7F7F]">{t('booking.finishSub')}</p>
      </div>
      <div className="flex flex-col gap-6">
        {store.modelName && (
          <div className="summary-row">
            <span className="summary-label">{t('booking.model')}</span>
            <span className="summary-value">{store.modelName}</span>
          </div>
        )}
        <div className="summary-row">
          <span className="summary-label">{t('booking.date')}</span>
          <span className="summary-value">{formattedDate}</span>
        </div>
        <div className="summary-row">
          <span className="summary-label">{t('booking.time')}</span>
        ...
        <div className="summary-row">
          <span className="summary-label">{t('booking.youPayLabel')}</span>
